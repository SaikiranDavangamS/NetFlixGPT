...
import { setGptState } from "../actions/gtpAction";
import { SUPPORTED_LANGUAGES } from "../utils/constants";
import { setLanguageAction } from "../actions/configAction";
...
{user &&(<div className="flex p-2 text-white">
  { gptState &&
(  <select onChange={handleLanguageChange} className="bg-green-800 text-white rounded-lg p-2">  
  ...
  <button className="py-2 px-4 mx-4 bg-purple-800 text-white rounded-lg " onClick={handleGptSearchClick}>{gptState  ?"HomePage": "GPT Search"}</button>
